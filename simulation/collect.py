...
if __name__ == '__main__':
    ...
    parser.add_argument("-d", help="data folder (default:data/)", type=str, default="data/")
    parser.add_argument("-N", help="number of samples per task(default:500)", default=[36])
